...
const SYSTEM_PROMPT = `Eres un sistema de extracción de datos contables. Analiza la imagen de la factura y devuelve ÚNICAMENTE un JSON válido con esta estructura exacta (sin texto adicional):
